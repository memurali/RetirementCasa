...
/***** auto_extract and monkeylearn API credentials ****/
	/** auto_extract **/
		Configure::write('auto_extract_user', '1a1a9a0781f7459786174010c9215b21');
		Configure::write('auto_extract_pass', '');

	/*** monkeylearn **/
		Configure::write('monkey_clientid', 'a788b10f6cb424feadad5b6ac04813f9ac64a8ab');
		Configure::write('monkey_modelid', 'cl_zvmN5ABU');
